...
class Recruiter_Campus_Peofile_Interview_Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Recruiter_Campus_Peofile_Interview_Screen> createState() =>
      _Recruiter_Campus_Peofile_Interview_ScreenState();
}

class _Recruiter_Campus_Peofile_Interview_ScreenState
    extends ConsumerState<Recruiter_Campus_Peofile_Interview_Screen> {
  Color? containColor;
  Text? TagText;
  ...
  Widget build(BuildContext context) {
    switch (widget.TagContain) {
      ...
      default:
        TagText = Text(
          'Shortlisted for Round ${widget.TagContain}',
          style: green12,
        );
        containColor = green3;
        break;
    ...
    return Scaffold(
      ...
      bottomNavigationBar: widget.TagContain == "Selected"
          ? null
              ...
              : Container(
                  ...
                  child: Row(
                    ...
                    children: [
                                            ...
                                            children: [
                                              Padding(
                                                padding: const EdgeInsets.only(
                                                    bottom: 20),
                                                child: Text(
                                                  "Are you sure want to reject  the candidate ?",
                                                  style: TitleT,
                                                ),
                                              ),
                                              Padding(
                      ...
                      Container(
                          width: MediaQuery.of(context).size.width / 2.3,
                          child: widget.TagContain == "Final Round"
                                                        ...
                                                        Padding(
                                                          padding:
                                                              const EdgeInsets
                                                                  ...
                                                                  bottom: 20),
                                                          child: Text(
                                                            "Are you sure want to select the candidate for next round ?",
                                                            style: TitleT,
                                                            textAlign: TextAlign
                                                                .center,
                                                          ),
                                                        ...
                                                        Padding(
                                                          padding:
                                                              const EdgeInsets
                                                                  ...
                                                                  bottom: 20),
                                                          child: Text(
                                                            "Are you sure want to select the candidate for final round ?",
                                                            style: TitleT,
                                                            textAlign: TextAlign
                                                                .center,
                                                          ),
                    ...
                    ? Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Center(
                                child: Text(
                              '${widget.time == "" ? SingleTon().setTime : widget.time}, ${widget.interviewDate == "" ? dateController.text : widget.interviewDate}',
                              style: Wbalck4,
                            )),
                          ],
                        ),
              ...
              child: Column(
                children: [
                  ...
                  contactDetails(context,
                      ...
                      Details: candiateProfileData?.preferredLocation ?? ""),
                  _detailInfo(),
                  _personalDetailsSection(candiateProfileData),
                  //EDUCATION HISTORY
                  candiateProfileData?.education == []
                      ? Container()
                      : _educationList(candiateProfileData),
                  //EMPLOYEEMENT HISTORY
                  candiateProfileData?.education == []
                      ? Container()
                      : _employeementHistory(candiateProfileData),
                ],
              ),
            ),
            SizedBox(
  ...
  SelectCandidateResponse() async {
    ...
    final updateCandidateJobResponse =
        await updateCandidateJobApiService.post<UpdateCandidateJobSatusModel>(
  ...
  CallForInterviewResponse() async {
    ...
    var formData = FormData.fromMap({
      ...
      "status": 6,
      "final_round": 0,
      "branch": branchResponseList?.length == null
          ? _Description.text
          : BranchListVal,
      "interview_date": dateController.text,
      "interview_time": SingleTon().setTime,
    });
    final callForInterviewResponse =
        await callForInterviewApiService.post<UpdateCandidateJobSatusModel>(
            context, ConstantApi.updateCandidateCampusJobSatusUrl, formData);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _profileInformation(
                title: 'Email Id', data: candiateProfileData?.email ?? ""),
            _profileInformation(
                title: 'Career Status',
                data: candiateProfileData?.careerStatus ?? ""),
            _profileInformation(
                title: 'Phone Number', data: candiateProfileData?.phone ?? ""),
            _profileInformation(
                title: 'Address', data: candiateProfileData?.address ?? ""),
            _profileInformation(
                title: 'Gender', data: candiateProfileData?.gender ?? ""),
            _profileInformation(
                title: 'Qualification',
            ...
            _profileInformation(
                title: 'Skill Sets', data: candiateProfileData?.skill ?? ""),
            _profileInformation(
                title: 'Current Arrears',
                data: candiateProfileData?.currentArrears ?? ""),
            _profileInformation(
                title: 'History of Arrears',
                data: candiateProfileData?.historyOfArrears ?? ""),
            _profileInformation(
                title: 'Current Percentage/CGPA',
                data: candiateProfileData?.currentPercentage ?? ""),
                  ...
                  Container(
                      ...
                      child: CommonElevatedButton(context, "Okay", () {
                        ...
                        showDialog(
                          context: context,
                          builder: (BuildContext context) =>
                              CampusCallInterview(context, onPress: () {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            candiateProfileData?.dob == ""
                ? Container()
                : _profileInformation(
                    title: 'Date of Birth',
                    data: candiateProfileData?.dob ?? ""),

            candiateProfileData?.nationality == null
                ? Container()
                : _profileInformation(
                    title: 'Nationality',
                    data: candiateProfileData?.nationality ?? ""),

            // _profileInformation(title: 'Languages Known', data: candiateProfileData?. ?? ""),

            candiateProfileData?.maritalStatus == ""
                ? Container()
                : _profileInformation(
                    title: 'Marital Status',
                    data: candiateProfileData?.maritalStatus ?? ""),

            candiateProfileData?.differentlyAbled == null
                ? Container()
                : _profileInformation(
                    title: 'Differently Abled',
                    data: candiateProfileData?.differentlyAbled ?? ""),

            candiateProfileData?.passport == null
                ? Container()
                : _profileInformation(
                    title: 'Passport Details',
                    data: candiateProfileData?.passport ?? ""),

            candiateProfileData?.careerBreak == null
                ? Container()
                : _profileInformation(
                    title: 'Career Break',
                    data: candiateProfileData?.careerBreak ?? ""),
          ],
        ),
      ),
    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        candiateProfileData?.education?[index].institute ?? "",
                        style: empHistoryT,
                      ),
                      Text(
                        candiateProfileData?.education?[index].qualification ??
                            "",
                        style: coursetxt,
                      ),
                      Text(
                        candiateProfileData?.education?[index].specialization ??
                            "",
                        style: coursetxt,
                      ),
                      Text(
                        "CGPA/Percentage: ${candiateProfileData?.education?[index].cgpa ?? ""}",
                        style: coursetxt,
                      ),
                      Text(
                        "${candiateProfileData?.education?[index].startDate ?? ""} - ${candiateProfileData?.education?[index].endDate ?? ""}",
                        style: durationT,
                      ),
                    ],
                  ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        candiateProfileData?.employment?[index].jobType ?? "",
                        style: empHistoryT,
                      ),
                      Text(
                      ...
                      Text(
                        candiateProfileData?.employment?[index].description ??
                            "",
                        style: durationT,
                      ),
                      Text(
                      ...
                      Text(
                        "${candiateProfileData?.employment?[index].startDate ?? ""} - ${candiateProfileData?.employment?[index].endDate ?? ""}",
                        style: durationT,
                      ),
                    ],
                  ),
