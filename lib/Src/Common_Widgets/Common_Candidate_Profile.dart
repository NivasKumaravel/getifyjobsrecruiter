...
class Direct_Candidate_Profile_Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Direct_Candidate_Profile_Screen> createState() =>
      Direct_Candidate_Profile_ScreenState();
}

class Direct_Candidate_Profile_ScreenState
    extends ConsumerState<Direct_Candidate_Profile_Screen> {
  Color? containColor;
  Text? TagText;
  ...
  Widget build(BuildContext context) {
    switch (widget.TagContain) {
      ...
      case "Recruiter Rescheduled":
        containColor = orange3;
        TagText = Text(
          'Recruiter Rescheduled Interview On',
          style: Yellow,
        );
        break;
    ...
    return Scaffold(
      bottomNavigationBar: widget.TagContain == "Schedule Requested"
          ? null
            ...
            children: [
                      ...
                      ? Padding(
                          ...
                          child: Column(
                            children: [
                              Center(
                                  child: Text(
                                'Call for Direct Interview on',
                                style: attacht1,
                              )),
                              Center(
                                  child: Text(
                                '${candiateProfileData?.scheduleRequested?.interviewTime == null ? SingleTon().setTime : candiateProfileData?.scheduleRequested?.interviewTime ?? ""}, '
                                '${candiateProfileData?.scheduleRequested?.interviewDate == null ? dateController.text : candiateProfileData?.scheduleRequested?.interviewDate ?? ""}',
                                style: Wbalck4,
                              )),
                            ],
                          ),
                                  ...
                                  ? Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Center(
                                              child: Text(
                                            '${candiateProfileData?.scheduleRequested?.interviewTime ?? ""}, ${candiateProfileData?.scheduleRequested?.interviewDate ?? ""}',
                                            style: Wbalck4,
                                          )),
                                          //RESCHEDULE REQUEST
                                          const SizedBox(
                                          ...
                                          Center(
                                              child: Text(
                                            '${candiateProfileData?.candidateReschedule?.interviewTime ?? ""}, ${candiateProfileData?.candidateReschedule?.interviewDate ?? ""}',
                                            style: Wbalck4,
                                          )),
                                          const SizedBox(
                                            height: 10,
                                          ...
                                          isRecReschedule == false
                                              ...
                                              : Column(
                                                  children: [
                                                    Center(
                                                        child: Text(
                                                      'Recruiter Requested for Rescheduled Interview on',
                                                      style: attacht1,
                                                    )),
                                                    Center(
                                                        child: Text(
                                                      '${candiateProfileData?.recruiterReschedule?.interviewTime == null ? SingleTon().setTime : candiateProfileData?.recruiterReschedule?.interviewTime ?? ""}, '
                                                      '${candiateProfileData?.recruiterReschedule?.interviewDate == null ? dateController.text : candiateProfileData?.recruiterReschedule?.interviewDate ?? ""}',
                                                      style: Wbalck4,
                                                    )),
                                                    const SizedBox(
                                                      height: 15,
                                      ...
                                      ? Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Center(
                                                  child: Text(
                                                'Requested for Reschedule Interview on',
                                                style: attacht1,
                                              )),
                                              Center(
                                                  child: Text(
                                              ...
                                              Center(
                                                  child: Text(
                                                'Recruiter Requested for Reschedule Interview on',
                                                style: attacht1,
                                              )),
                                              Center(
                                                  child: Text(
                                                '${candiateProfileData?.recruiterReschedule?.interviewTime == null ? SingleTon().setTime : candiateProfileData?.recruiterReschedule?.interviewTime}, ${candiateProfileData?.recruiterReschedule?.interviewDate == null ? dateController.text : candiateProfileData?.recruiterReschedule?.interviewDate ?? ""}',
                                                style: Wbalck4,
                                              )),
                                              const SizedBox(
                                                height: 15,
                                          ...
                                          ? Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Center(
                                                      child: Text(
                                                    '${candiateProfileData?.scheduleAccepted?.interviewTime == null ? candiateProfileData?.candidateReschedule?.interviewTime ?? "" : candiateProfileData?.scheduleAccepted?.interviewTime ?? ""}, ${candiateProfileData?.scheduleAccepted?.interviewDate == null ? dateController.text : candiateProfileData?.scheduleAccepted?.interviewDate ?? ""}',
                                                    style: Wbalck4,
                                                  )),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Center(
                                                        child: Text(
                                                      'Do you want to reschedule the interview date?',
                                                      style: attacht1,
                                                    )),
                                                  ),
                                                  Container(
                                              ...
                                              ? Padding(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      Center(
                                                          child: Text(
                                                        'Rescheduled Direct Interview on',
                                                        style: attacht1,
                                                      )),
                                                      Center(
                                                          child: Text(
                                                        '${candiateProfileData?.interviewReschedule?.interviewTime == null ? SingleTon().setTime : candiateProfileData?.interviewReschedule?.interviewTime ?? ""}, '
                                                        '${candiateProfileData?.interviewReschedule?.interviewDate == null ? dateController.text : candiateProfileData?.interviewReschedule?.interviewDate ?? ""}',
                                                        style: Wbalck4,
                                                      )),
                                                    ],
                                                  ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    profileImg(
                        ProfileImg: candiateProfileData?.profilePic ?? ""),
                    Center(
                        child: Text(
                      candiateProfileData?.name ?? "",
                      style: TitleT,
                    )),
                    ...
                    candiateProfileData?.employment == []
                        ? Container()
                        : _employeement_List(),
                    //EDUCATION LIST
                    _education_List(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          candiateProfileData?.careerStatus == 'Fresher'
              ? Container()
              : candiateProfileData?.careerStatus == 'Student'
                  ? Container()
                  : candiateProfileData?.careerStatus == 'Experienced'
                      ? candiateProfileData?.designation == null
                          ? Container()
                          : _profileInformation(
                              title: 'Designation',
                              data: candiateProfileData?.designation ?? "")
                      : candiateProfileData?.experience == null
                          ? Container()
                          : _profileInformation(
                              title: 'Experience',
                              data: candiateProfileData?.experience ?? ""),
          candiateProfileData?.careerStatus == null
              ? Container()
              : _profileInformation(
                  title: 'Career Status',
                  data: candiateProfileData?.careerStatus ?? ""),
          _profileInformation(
              title: 'Skill Set', data: candiateProfileData?.skill ?? ""),
          _profileInformation(
              title: 'Qualification',
              data: candiateProfileData?.qualification ?? ""),
          _profileInformation(
              title: 'Specialization',
              data: candiateProfileData?.specialization ?? ""),
          _profileInformation(
              title: 'Preferred Location',
              data: candiateProfileData?.preferredLocation ?? ""),
          candiateProfileData?.currentSalary == null
              ? Container()
              : _profileInformation(
                  title: 'Current Salary',
                  data: candiateProfileData?.currentSalary ?? ""),
          candiateProfileData?.expectedSalary == ''
              ? Container()
              : _profileInformation(
                  title: 'Expected Salary',
                  data: candiateProfileData?.expectedSalary ?? ""),
        ],
      ),
    );
  }
  ...
  CandidateCampusProfileResponse() async {
    ...
    final candidateCampusProfileResponse =
        await candidateCampusProfileApiService
            .post<CandidateCampusProfileModel>(
                context, ConstantApi.campusCandidateProfileUrl, formData);
  ...
  RequestCallResponse() async {
    ...
    final requestCallResponse = await requestCallApiService
        .post<RequestCallModel>(context, ConstantApi.requestCallUrl, formData);
  ...
  ScheduledResponse() async {
    ...
    var formData = FormData.fromMap({
      ...
      "status": 3,
      "branch":
          branchResponseList?.length == null ? _location.text : BranchListVal,
    ...
    final scheduleApiResponse =
        await ScheduleApiService.post<UpdateCandidateJobSatusModel>(
            context, ConstantApi.updateDirectJobStatusUrl, formData);
    if (scheduleApiResponse?.status == true) {
      ...
      scheduleApiResponse?.message ==
              "Interviews can be scheduled in future time."
          ? null
          : Navigator.push(context,
              MaterialPageRoute(builder: (context) => Wallet_Coin_Screen()));
  ...
  BranchListResponse() async {
    ...
    final branchListResponse = await branchListApiService.post<BranchListModel>(
        context, ConstantApi.branchListUrl, formData);
    if (branchListResponse?.status == true) {
      ...
      setState(() {
        ...
        BranchListOption =
            branchListResponse!.data!.map((e) => e.branchName ?? "").toList();
  ...
  AddOfferResponse() async {
    ...
    if (SingleTon().setPdf != null) {
      formData.files.addAll([
        MapEntry('offer_letter',
            await MultipartFile.fromFile(SingleTon().setPdf!.path)),
      ]);
    }
  ...
  RescheduleDateResponse() async {
    ...
    final rescheduleApiResponse =
        await rescheduleDateApiService.post<RequestCallModel>(
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return _experienceList(
            expdesignation:
                candiateProfileData?.employment?[index].jobRole ?? "",
            expcompany:
                candiateProfileData?.employment?[index].companyName ?? "",
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                      height: 25, width: 25, child: ImgPathSvg("xcancel.svg")),
                )
              ],
            ),
            Padding(
            ...
            widget.TagContain == "Shortlisted"
                ? Container()
                : CommonElevatedButton(context, "ShortList", () {
                    ShortlistedResponse();
                  }),
            Padding(
              ...
              child: CommonElevatedButton(context, "Call for Interview", () {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) =>
                      InterviewSchedulePopupWeb(context),
                );
              }),
            ),
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: [
            //DATE PICKER
            Text(
              "Please Select the date & time for the Interview",
              style: Wbalck1,
                        ...
                        if (branchResponseList?.length == 0) {
                          ...
                          if (_selectedTime == null ||
                            ...
                            showDialog(
                              context: context,
                              builder: (BuildContext context) =>
                                  InterviewConfirmationPopupWeb(context,
                                      onPress: () {
                                ScheduledResponse();
                              }),
                            );
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: [
            //DATE PICKER
            Text(
              "Are you sure want to select the candidate",
              style: Wbalck1,
              textAlign: TextAlign.center,
            ),
    ...
    child: Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(10), color: blue1),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
...
Widget _personalDetailsSection({
  ...
  required StringDifferentlyAbled,
  required String Doyouhavepassport,
  required String CareerBreak,
}) {
  return Padding(
    padding: const EdgeInsets.only(top: 15),
    child: Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (DOB.isNotEmpty)
              _profileInformation(title: 'Date of Birth', data: DOB),
            if (Nationality.isNotEmpty)
              _profileInformation(title: 'Nationality', data: Nationality),
            if (LanguagesKnown.isNotEmpty)
              _profileInformation(
                  title: 'Languages Known', data: LanguagesKnown),
            if (MaritalStatus.isNotEmpty)
              _profileInformation(title: 'Marital Status', data: MaritalStatus),
            if (StringDifferentlyAbled.isNotEmpty)
              _profileInformation(
                  title: 'Differently Abled', data: StringDifferentlyAbled),
            if (Doyouhavepassport.isNotEmpty)
              _profileInformation(
                  title: 'Passport Details', data: Doyouhavepassport),
            if (CareerBreak.isNotEmpty)
...
Widget _experienceList(
    {required String expdesignation,
    required String expcompany,
    required String expworktype,
    required String expduration,
    required String expnoticeperiod}) {
  return Padding(
    padding: const EdgeInsets.only(top: 10),
    child: Container(
      decoration:
